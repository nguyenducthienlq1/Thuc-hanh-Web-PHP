...
<div class="container">
    ...
    <form method="POST" action="/webbanhang/Product/update" enctype="multipart/form-data" onsubmit="return validateForm();">
        ...
        <div class="form-group">
            ...
            <?php if (!empty($product->image)) : ?>
                <div class="mt-2">
                    <img src="/webbanhang/<?= htmlspecialchars($product->image, ENT_QUOTES, 'UTF-8'); ?>" alt="Ảnh sản phẩm" style="max-width: 150px; height: auto; border-radius: 5px; box-shadow: 0px 0px 5px rgba(0,0,0,0.1);">
                </div>
            <?php endif; ?>
        </div>
    ...
    <a href="/webbanhang/Product" class="btn btn-secondary mt-3">Quay lại danh sách sản phẩm</a>
</div>
